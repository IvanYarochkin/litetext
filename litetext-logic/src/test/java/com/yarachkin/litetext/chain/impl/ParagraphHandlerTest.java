...
public class ParagraphHandlerTest {
    ...
    public void setUp() throws Exception {
        ...
        testFile = File.createTempFile("litetext_paragraph_handler_test", "txt");
    ...
    public void testParse() throws Exception {
        ...
        assertEquals(paragraphHandler.parse(LiteTextFileReader.getInstance().readFromFile()).toString(), result);
    }
}